...
- 課題管理だけでなく、遅延検知と次アクション提示まで含めて「意思決定支援」を狙ったこと
- OpenAPI + aspida によって、API 契約をフロントとバックで共有していること
- 課題、アラート、サーベイのような異なる関心を feature 単位で分けていること
- バックエンドを責務ごとに分け、UI 側の変更と業務ロジックの変更を切り離しやすくしていること
- MVP としてまずデスクトップ体験と主要導線に集中し、段階的に機能を積み上げたこと
